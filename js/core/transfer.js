...
export const APP_VERSION="0.10.0-alpha9";
...
export const TransferManager={
 ...
 export(project=ProjectManager.ensure()){const data=this.build(project),blob=new Blob([JSON.stringify(data,null,2)],{type:"application/json"}),url=URL.createObjectURL(blob),a=document.createElement("a");a.href=url;a.download=`${safeName(project.name)}.fenixmobile`;a.click();setTimeout(()=>URL.revokeObjectURL(url),1000);return data},
